          ...
          >
            ...
            <div className="mt-6 flex gap-3">
              <button
                ...
                className="flex items-center gap-2 rounded-md bg-primary px-6 py-3 font-body text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/80"
              >
                <Play className="h-5 w-5" /> Watch Now
              </button>
              <button
                onClick={() => navigate(`/tmdb/${mediaType}/${movie.id}`)}
                className="flex items-center gap-2 rounded-md bg-secondary px-6 py-3 font-body text-sm font-semibold text-secondary-foreground transition-all hover:bg-secondary/80"
              >
